...
describe("when there is initially one user in db", () => {
  ...
  test("creation fails with username identical to db, same as the initial one", async () => {
    ...
    const res = await api.post("/users").send(newUser).expect(400)
